...
def build_pdf(filename):
    ...
    story.append(Paragraph("&bull; <b>Nivel 6 — Regla de los 3 Fallos &amp; Recuperación Obligatoria por Correo:</b> Si una clienta introduce una contraseña errónea más de 3 veces, se suspende el acceso con esa clave antigua y se exige obligatoriamente crear una contraseña nueva validada mediante código OTP de 6 dígitos enviado a su correo registrado.", bullet_style))
    story.append(Paragraph("&bull; <b>Nivel 7 — Autenticación Social (Google &amp; Apple) &amp; Persistencia:</b> Se integraron botones nativos de Google y Apple con verificación inmediata de correo. Al volver a la app, se asigna su contraseña/PIN seguro en la base de datos Neon y se ofrece la casilla 'Recordar en este dispositivo' y visor de contraseña.", bullet_style))
    story.append(Spacer(1, 6))
